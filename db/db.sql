...
INSERT INTO `lecture` (`title`, `author`, `description`, `chunks`, `id_category`) VALUES
    ...
    ('Umbra lui Mircea la Cozia', 'Grigore Alexandrescu', 'Poezia este un omagiu adus lui Mircea cel Bătrân, redând respectul față de istoria națională și momente de reflecție patriotică la mănăstirea Cozia.', 30, (SELECT `id` FROM `lecture_category` WHERE `name` = 'Liric'));
